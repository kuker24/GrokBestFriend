...
GRT_DI_BANK_REQUEST="${GRT_DI_BANK_REQUEST:-0}"
GRT_DI_BANK_SKIP="${GRT_DI_BANK_SKIP:-0}"
GRT_DI_ARCHIVE_DIR="${GRT_DI_ARCHIVE_DIR:-}"
GRT_DI_ACTION="${GRT_DI_ACTION:-skip}"
GRT_DI_CREATED="${GRT_DI_CREATED:-0}"
GRT_DI_STAGING="${GRT_DI_STAGING:-}"
GRT_DI_TARGET="${GRT_DI_TARGET:-}"
GRT_DI_TARGET_DISPLAY="${GRT_DI_TARGET_DISPLAY:-~/DesignIntelligence}"
GRT_DI_RECOVERY="${GRT_DI_RECOVERY:-}"
GRT_DI_SNAPSHOT="${GRT_DI_SNAPSHOT:-}"
GRT_DI_TX_ID="${GRT_DI_TX_ID:-}"
GRT_DI_MANIFEST_FILE="${GRT_DI_MANIFEST_FILE:-}"
GRT_GROK="${GRT_GROK:-}"
